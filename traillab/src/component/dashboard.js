...
function Dashboard() {
  ...
  return (
    <Card sx={{ backgroundColor: '#f5f5f5', padding: '1rem' }}>
      ...
      <Dialog open={isEditFormVisible} onClose={handleCancelEdit}>
        <DialogTitle>Edit Item</DialogTitle>
        <DialogContent>
          name <TextField name="name" value={editData.name} onChange={handleEditChange} fullWidth />
          avatar <TextField name="avatar" value={editData.avatar} onChange={handleEditChange} fullWidth />
          age <TextField name="age" value={editData.age} onChange={handleEditChange} fullWidth />
          createdAt <TextField name="createdAt" value={editData.createdAt} onChange={handleEditChange} fullWidth />
          address <TextField name="address" value={editData.address} onChange={handleEditChange} fullWidth />
        </DialogContent>
        <DialogActions>
